...
- Effect plugins import `@kilocode/plugin/v2/effect`, not `@opencode-ai/core`.
- Public domain values use generated `@kilocode/sdk` types.
...
- Define `PluginHost` domain capabilities in `@kilocode/plugin/v2/effect`.
