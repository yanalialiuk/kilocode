...
- Canonicalize ambient instruction traversal boundaries, honor `KILO_DISABLE_PROJECT_CONFIG`, and make non-empty aggregate updates explicitly supersede previously loaded instructions.
